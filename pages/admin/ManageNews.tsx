...
import { Post, DisplayBlock, Attachment } from '../../types';
...
export const ManageNews: React.FC<ManageNewsProps> = ({ posts, refreshData }) => {
  ...
  const EditorToolbar = () => (
    <div className="flex flex-wrap gap-1 p-2 bg-gray-100 border-b border-gray-300 sticky top-0 z-10">
       ...
       <div className="flex items-center space-x-1 text-gray-700">
          <label className="p-1.5 hover:bg-gray-200 rounded cursor-pointer" title="Chèn ảnh">
             <Image size={16}/>
  ...
  const getCategoryName = (cat: string) => {
    switch(cat) {
        case 'news': return 'Tin Tức & Sự kiện';
        case 'announcement': return 'Thông báo';
        case 'activity': return 'Hoạt động phong trào';
        case 'professional': return 'Hoạt động chuyên môn';
        default: return cat;
    }
  };
        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1 bg-white p-6 rounded shadow-sm border border-gray-200">
               ...
               {/* Series/Event (Mock) */}
               <div className="grid grid-cols-12 gap-4 mb-4 items-center">
                  <label className="col-span-12 md:col-span-2 font-bold text-gray-700">Thuộc dòng sự kiện:</label>
                  <div className="col-span-12 md:col-span-10 flex gap-2">
                     <select className="border border-gray-300 p-2 rounded w-1/3 bg-white text-gray-900 outline-none">
                        <option>Chọn nhóm tin liên quan hoặc tự điền</option>
                     </select>
                     <input type="text" className="flex-1 border border-gray-300 p-2 rounded bg-gray-50" disabled />
                  </div>
               </div>
               ...
               <div className="grid grid-cols-12 gap-4 mb-6 items-center">
                  <label className="col-span-12 md:col-span-2 font-bold text-gray-700">Trình bày hình:</label>
                  <div className="col-span-12 md:col-span-10">
                     <select className="border border-gray-300 p-2 rounded w-48 bg-white text-gray-900 outline-none">
                        <option>Không hiển thị</option>
                        <option>Hiển thị đầu bài</option>
                        <option>Hiển thị cuối bài</option>
                     </select>
                  </div>
               </div>
            ...
            <div className="w-full lg:w-80 flex flex-col gap-4">
               ...
               <div className="bg-white border border-gray-200 rounded p-4 shadow-sm">
                  ...
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                     {['news', 'announcement', 'activity', 'professional'].map(cat => (
                        <label key={cat} className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-1 rounded transition">
                           <input 
                              type="radio" 
                              name="category" 
               ...
               {/* Discussion */}
               <div className="bg-white border border-gray-200 rounded p-4 shadow-sm">
                  <h4 className="font-bold text-gray-800 mb-3 text-xs uppercase border-b pb-2">Cho phép thảo luận:</h4>
                  <div className="space-y-1 text-sm text-gray-500">
                     <label className="flex gap-2 items-center"><input type="checkbox" disabled className="rounded border-gray-300"/> Quản trị tối cao</label>
                     <label className="flex gap-2 items-center"><input type="checkbox" disabled className="rounded border-gray-300"/> Điều hành chung</label>
                     <label className="flex gap-2 items-center"><input type="checkbox" disabled className="rounded border-gray-300"/> Thành viên chính thức</label>
                     <label className="flex gap-2 items-center"><input type="checkbox" disabled className="rounded border-gray-300"/> Khách</label>
                  </div>
               </div>
               ...
               <div className="bg-white border border-gray-200 rounded p-4 shadow-sm">
                  ...
                  <div className="space-y-2 text-sm">
                     ...
                     <label className="flex gap-2 items-center cursor-pointer text-gray-500">
    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-100 text-gray-700 text-sm font-bold uppercase"><th className="px-6 py-4">Trạng thái</th><th className="px-6 py-4">Tiêu đề</th><th className="px-6 py-4">Ngày đăng</th><th className="px-6 py-4 text-right">Hành động</th></tr>
            </thead>
